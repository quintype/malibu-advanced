...
describe("Alsoread Story Element", () => {
  ...
  it("Should render default template with text color", () => {
    ...
    expect(wrapper.html()).toBe(
      '<a data-test-id="also-read" aria-label="also-read" class="arrow-component arr--also-read-element also-read-m_alsoread-default__3cYER " href="https://ace-web.qtstage.io/anything/coronavirus/how-is-the-coronavirus-impacting-people-with-disabilities"><div class="also-read-m_card-image-wrapper__3GFzu"><figure class="also-read-m_card-image__3CwAv"><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" alt="hero image caption" class="qt-image"/></figure></div><div class="also-read-m_content-wrapper__26AZX"><div style="color:#3333" class="also-read-m_headline__VzF-c also-read-m_dark__1pUib">How is the coronavirus impacting people with disabilities?</div></div></a>'
    );
  });
  ...
  it("Should render text left align template with custom title", () => {
    ...
    expect(wrapper.html()).toBe(
      '<a data-test-id="also-read" aria-label="also-read" class="arrow-component arr--also-read-element also-read-m_alsoread-textLeftAlign__S0Dxe " href="https://ace-web.qtstage.io/anything/coronavirus/how-is-the-coronavirus-impacting-people-with-disabilities"><div class="also-read-m_default-text__hp2dp also-read-m_dark__1pUib">Also-Read</div><div class="also-read-m_content-wrapper__26AZX"><div style="color:initial" class="also-read-m_headline__VzF-c also-read-m_dark__1pUib">How is the coronavirus impacting people with disabilities?</div></div></a>'
    );
  });
