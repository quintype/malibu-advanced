...
const LoginBase = ({ onLogin, forgotPassword, manageLoginForm }) => {
  ...
  const redirectUrl = domainSlug
    ? "https://malibu-voices-advanced-web.qtstage.io/opinion/sajad-lone-quits-gupkar-alliance-is-this-the-full-story/api/auth/v1/oauth/token"
    : "https://malibu-advanced-web.qtstage.io/food/dosa/dailymotion-video/api/auth/v1/oauth/token";
