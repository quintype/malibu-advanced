...
import FourColTwelveStory from "../../../../arrow/components/Rows/FourColTwelveStory";
...
export const ArrowFourColTwelveStories = ({ collection }) => {
  ...
  return <FourColTwelveStory collection={collection} config={config} />;
};
ArrowFourColTwelveStories.propTypes = {
  collection: object,
};

ArrowFourColTwelveStories.storyLimit = 16;
