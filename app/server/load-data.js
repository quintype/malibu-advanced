  ...
  function _loadData () {
    switch (pageType) {
      case PAGE_TYPE.HOME_PAGE:
        return loadHomePageData(client, config, params)
      case PAGE_TYPE.HOME_PREVIEW:
        return loadHomePageData(client, config)
      case PAGE_TYPE.HOME_PAGE_PREVIEW:
        return loadHomePageData(client, config, params, publisher?.qt_internal_apps_key)
      ...
      case PAGE_TYPE.COLLECTION_PAGE:
        return loadCollectionPageData(client, params, config)
      case PAGE_TYPE.COLLECTION_PAGE_PREVIEW:
        return loadCollectionPageData(client, params, config, publisher?.qt_internal_apps_key)
